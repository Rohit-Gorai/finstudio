...
(function () {
  ...
  LS.lessons["2220-project-pl"] = {
    ...
    body: [
      ...
      { t: "where", h: "This projected <strong>income statement</strong> feeds everything downstream: PAT drives retained earnings, EBIT drives the free cash flow you'll build next, and both flow into the valuation in lesson 2240." },
  ...
  LS.lessons["2230-fcff"] = {
    ...
    body: [
      ...
      { t: "note", h: "Notice how much smaller FCFF is than EBITDA (" + R(rd(y26.pl.ebitda)) + " in FY26). The difference is tax, the capex needed to stand still, and the working capital growth consumes. This is the concrete answer to why EBITDA is not cash flow — a point lesson 1430 made in words and this sheet makes in rupees." },
  ...
  LS.lessons["2250-valuation-capstone"] = {
    ...
    body: [
      ...
      { t: "where", h: "This is the end of the chain that started with lesson 1010's five buckets. Assets and liabilities became a balance sheet, revenue and expenses became an income statement, the two became a cash flow statement, the three became a linked model, and the model became a valuation. Every number traceable to a café in Mumbai." },
