...
(function () {
  ...
  LS.lessons["2110-three-bridges"] = {
    ...
    body: [
      ...
      ], note: "Each is a roll-forward: opening + increases − decreases = closing. You've built all three already — in the “Retained earnings” lesson, 1530 and 1550. Module 2100 just puts them in one sheet." },
  ...
  LS.lessons["2120-linked-model"] = {
    ...
    body: [
      ...
      { t: "mcq", q: "In your model, why does FY26 cash depend on FY25 cash rather than being computed from scratch?", opts: ["Convenience — it saves typing", "Because cash is a balance that carries over; the statement only ever explains the change", "Because Excel requires it", "It doesn't — either method works identically"], correct: 1, why: ["It does save typing, but the reason is conceptual, not practical.", "Cash is a <em>stock</em> — it persists. The cash flow statement measures a <em>flow</em>, the change during the year. Closing = opening + change is the only way to connect them, which is exactly the stocks-vs-flows distinction from the “The three statements” lesson. Every balance sheet line in this model rolls forward the same way; only the flows are computed fresh each year.", "The spreadsheet doesn't care; the accounting does.", "Computing cash from scratch each year would mean re-deriving every transaction since the café opened — and it would silently lose any opening balance."] }
    ]
  };
