...
(function () {
  ...
  LS.lessons["1320-retained-earnings"] = {
    ...
    body: [
      ...
      { t: "formula", title: "The retained earnings bridge", lines: ["Closing RE = Opening RE + <b>Profit after tax</b> − Dividends"], note: "This is bridge #1 of the three-statement link (module 2100): the income statement's bottom line flows into the balance sheet through this exact formula." },
