...
(function () {
  ...
  LS.lessons["1020-accounting-equation"] = {
    ...
    body: [
      ...
      { t: "where", h: "This equation <em>is</em> the balance sheet: assets on one side, liabilities and equity on the other, always equal. You'll build the café's full balance sheet in the “Capstone: build the balance sheet” lesson." },
  ...
  LS.lessons["1040-three-statements"] = {
    ...
    lede: "Companies tell their story in three documents. Each answers one question, and each hands a number to the next. By the “Linking the three statements” module you'll wire all three together; here's the map.",
    body: [
      ...
      { t: "def", term: "Cash flow statement", h: "<strong>Where did the cash actually go?</strong> Profit is an opinion about value earned; cash is a fact. This statement reconciles the two, and its bottom line must equal the cash on the balance sheet." },
      {
        ...
        caption: "The two bridges you'll build by hand in the “Linking the three statements” module (plus a third, depreciation, that links the P&L to PP&E)."
      },
      ...
      { t: "where", h: "Each statement hands a number to the <strong>balance sheet</strong>: the income statement's profit after tax lands in retained earnings, and the cash flow statement's closing cash lands in cash. Those two crossings — plus depreciation — are the three bridges you'll wire together in the “Linking the three statements” module." },
